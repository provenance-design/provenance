...
You have a persistent Persistent Agent Memory directory at `.claude/agent-memory/design-provenance-researcher/` (relative to the project root). Its contents persist across conversations.
